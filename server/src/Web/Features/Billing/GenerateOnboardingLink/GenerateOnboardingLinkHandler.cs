...
{
    public class GenerateOnboardingLinkHandler : IRequestHandler<GenerateOnboardingLinkQuery, string>
    {
        private readonly IAuthenticator authenticator;
        private readonly IUnitOfWork unitOfWork;
        private readonly IBillingService billingService;

        public GenerateOnboardingLinkHandler(IAuthenticator authenticator, IUnitOfWork unitOfWork, IBillingService billingService)
        {
        ...
        public async Task<Result<string>> Handle(
            GenerateOnboardingLinkQuery query,
