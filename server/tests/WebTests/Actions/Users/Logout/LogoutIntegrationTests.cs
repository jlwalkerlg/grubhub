...
namespace WebTests.Actions.Users.Logout
{
    public class LogoutIntegrationTests : WebIntegrationTestBase
    {
        public LogoutIntegrationTests(WebIntegrationTestFixture fixture) : base(fixture)
        {
        }
