...
namespace WebTests.Integration.Users.Login
{
    public class LoginTests : WebIntegrationTestBase
    {
        public LoginTests(WebAppIntegrationTestFixture fixture) : base(fixture)
        {
        }
