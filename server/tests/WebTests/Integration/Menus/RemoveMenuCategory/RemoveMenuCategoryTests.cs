...
namespace WebTests.Integration.Menus.RemoveMenuCategory
{
    public class RemoveMenuCategoryTests : WebIntegrationTestBase
    {
        public RemoveMenuCategoryTests(WebAppIntegrationTestFixture fixture) : base(fixture)
        {
        }
