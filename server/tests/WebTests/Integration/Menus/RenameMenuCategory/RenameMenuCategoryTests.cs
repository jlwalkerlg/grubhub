...
namespace WebTests.Integration.Menus.RenameMenuCategory
{
    public class RenameMenuCategoryTests : WebIntegrationTestBase
    {
        public RenameMenuCategoryTests(WebAppIntegrationTestFixture fixture) : base(fixture)
        {
        }
